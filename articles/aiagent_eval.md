...
この記事がエージェントシステムの設計、改善の参考になりますと幸いです。
...
エージェント設計をする際は**人間におきかえて考える**と効果的です。
...
詳細には触れませんが、プロンプト設計では「Xしないでください」ではなく、「Yしてください」が効果的だと学びました。
...
定量、定性にするなどが考えられます。
大規模なシステムの場合、評価を生成AIに任せたり、評価ツールを利用するなど
さらなる工夫が必要だといえます。
評価指標・評価方法については今後ブラッシュアップしていきます。
開発経験はまだまだ浅いのですが、AIシステムの開発は通常の開発に置き換えて考えられると
学びました。
